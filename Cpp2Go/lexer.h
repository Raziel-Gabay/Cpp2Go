...
#define STD_CERR_KEYWORD "std::cerr"
#define STD_CERR_LEN 9
#define IF "if"
#define ELSE "else"
#define HASHTAG "#"
...
public:
	...
	static void deleteCaretReturn(std::string& sourceCode);
	...
	static bool isStdCerr(std::string& code, std::string& token);
